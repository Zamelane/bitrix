<?
   ...
   * На примере добавления скидки при условии, что регион дальний (кастомное свойство в свойствах заказа. В checkRegion ищем его id и через переданную запись заказа проверяю, какое у неё значение).
  */
?>
